export default {
  ...
  CHANGE_CONVERSATION_PIPELINE_STATUS: 'CHANGE_CONVERSATION_PIPELINE_STATUS',
  ...
  // Marketing Campaign
  SET_MARKETING_CAMPAIGN_FETCHING_STATUS:
    'SET_MARKETING_CAMPAIGN_FETCHING_STATUS',
  SET_MARKETING_CAMPAIGN_CREATING_STATUS:
    'SET_MARKETING_CAMPAIGN_CREATING_STATUS',
  SET_MARKETING_CAMPAIGN_UPDATING_STATUS:
    'SET_MARKETING_CAMPAIGN_UPDATING_STATUS',
  SET_MARKETING_CAMPAIGN_DELETING_STATUS:
    'SET_MARKETING_CAMPAIGN_DELETING_STATUS',
  ...
  // Pipeline Statuses
  SET_PIPELINE_STATUS_FETCHING_STATUS: 'SET_PIPELINE_STATUS_FETCHING_STATUS',
  SET_PIPELINE_STATUS_CREATING_STATUS: 'SET_PIPELINE_STATUS_CREATING_STATUS',
  SET_PIPELINE_STATUS_UPDATING_STATUS: 'SET_PIPELINE_STATUS_UPDATING_STATUS',
  SET_PIPELINE_STATUS_DELETING_STATUS: 'SET_PIPELINE_STATUS_DELETING_STATUS',
  SET_PIPELINE_STATUSES: 'SET_PIPELINE_STATUSES',
  ADD_PIPELINE_STATUS: 'ADD_PIPELINE_STATUS',
  EDIT_PIPELINE_STATUS: 'EDIT_PIPELINE_STATUS',
  DELETE_PIPELINE_STATUS: 'DELETE_PIPELINE_STATUS',
  SET_PIPELINE_STATUS_LOADING: 'SET_PIPELINE_STATUS_LOADING',
  ORGANIZE_CONVERSATIONS_BY_PIPELINE_STATUS:
    'ORGANIZE_CONVERSATIONS_BY_PIPELINE_STATUS',
  TOGGLE_SINGLE_PIPELINE_STATUS: 'TOGGLE_SINGLE_PIPELINE_STATUS',
  REORDER_PIPELINE_STATUSES: 'REORDER_PIPELINE_STATUSES',
  ...
  // Product Catalogs
  SET_PRODUCT_CATALOG_UI_FLAG: 'SET_PRODUCT_CATALOG_UI_FLAG',
  SET_PRODUCT_CATALOGS: 'SET_PRODUCT_CATALOGS',
  SET_PRODUCT_CATALOG_META: 'SET_PRODUCT_CATALOG_META',
  ADD_PRODUCT_CATALOG: 'ADD_PRODUCT_CATALOG',
  EDIT_PRODUCT_CATALOG: 'EDIT_PRODUCT_CATALOG',
  DELETE_PRODUCT_CATALOG: 'DELETE_PRODUCT_CATALOG',

  // Product Blueprints
  SET_PRODUCT_BLUEPRINT_UI_FLAG: 'SET_PRODUCT_BLUEPRINT_UI_FLAG',
  SET_PRODUCT_BLUEPRINTS: 'SET_PRODUCT_BLUEPRINTS',
  SET_PRODUCT_BLUEPRINT: 'SET_PRODUCT_BLUEPRINT',
  SET_PRODUCT_BLUEPRINT_META: 'SET_PRODUCT_BLUEPRINT_META',

  // FAQ Categories
  SET_FAQ_CATEGORY_UI_FLAG: 'SET_FAQ_CATEGORY_UI_FLAG',
  SET_FAQ_CATEGORIES: 'SET_FAQ_CATEGORIES',
  SET_FAQ_CATEGORIES_META: 'SET_FAQ_CATEGORIES_META',
  SET_FAQ_CATEGORY_TREE: 'SET_FAQ_CATEGORY_TREE',
  ADD_FAQ_CATEGORY: 'ADD_FAQ_CATEGORY',
  EDIT_FAQ_CATEGORY: 'EDIT_FAQ_CATEGORY',
  DELETE_FAQ_CATEGORY: 'DELETE_FAQ_CATEGORY',

  // FAQ Items
  SET_FAQ_ITEM_UI_FLAG: 'SET_FAQ_ITEM_UI_FLAG',
  SET_FAQ_ITEMS: 'SET_FAQ_ITEMS',
  SET_FAQ_ITEMS_META: 'SET_FAQ_ITEMS_META',
  ADD_FAQ_ITEM: 'ADD_FAQ_ITEM',
  EDIT_FAQ_ITEM: 'EDIT_FAQ_ITEM',
  DELETE_FAQ_ITEM: 'DELETE_FAQ_ITEM',

  // Bulk Processing Requests
  SET_BULK_PROCESSING_REQUEST_UI_FLAG: 'SET_BULK_PROCESSING_REQUEST_UI_FLAG',
  SET_BULK_PROCESSING_REQUESTS: 'SET_BULK_PROCESSING_REQUESTS',
  ADD_BULK_PROCESSING_REQUEST: 'ADD_BULK_PROCESSING_REQUEST',
  UPDATE_BULK_PROCESSING_REQUEST: 'UPDATE_BULK_PROCESSING_REQUEST',
  ...
  // Surveys
  SET_SURVEY_UI_FLAG: 'SET_SURVEY_UI_FLAG',
  ...
  SET_APPOINTMENTS_META: 'SET_APPOINTMENTS_META',
  CLEAR_APPOINTMENTS: 'CLEAR_APPOINTMENTS',
  SET_APPOINTMENTS_FETCHING_STATUS: 'SET_APPOINTMENTS_FETCHING_STATUS',
  SET_APPOINTMENT_CREATING_STATUS: 'SET_APPOINTMENT_CREATING_STATUS',
  SET_APPOINTMENT_UPDATING_STATUS: 'SET_APPOINTMENT_UPDATING_STATUS',
  SET_APPOINTMENT_DELETING_STATUS: 'SET_APPOINTMENT_DELETING_STATUS',
  SET_APPLIED_APPOINTMENT_FILTERS: 'SET_APPLIED_APPOINTMENT_FILTERS',
  CLEAR_APPLIED_APPOINTMENT_FILTERS: 'CLEAR_APPLIED_APPOINTMENT_FILTERS',

  // CRM Flows
  SET_CRM_FLOWS_UI_FLAG: 'SET_CRM_FLOWS_UI_FLAG',
  SET_CRM_FLOWS: 'SET_CRM_FLOWS',
  ADD_CRM_FLOW: 'ADD_CRM_FLOW',
  EDIT_CRM_FLOW: 'EDIT_CRM_FLOW',
  DELETE_CRM_FLOW: 'DELETE_CRM_FLOW',
  SET_CRM_FLOW_EXECUTIONS: 'SET_CRM_FLOW_EXECUTIONS',
  SET_CRM_FLOW_CONVERSATION_EXECUTIONS: 'SET_CRM_FLOW_CONVERSATION_EXECUTIONS',

  // Locations
  SET_LOCATIONS: 'SET_LOCATIONS',
  SET_USER_LOCATIONS: 'SET_USER_LOCATIONS',
  SET_LOCATIONS_META: 'SET_LOCATIONS_META',
  CLEAR_LOCATIONS: 'CLEAR_LOCATIONS',
  SET_LOCATIONS_FETCHING_STATUS: 'SET_LOCATIONS_FETCHING_STATUS',
  SET_LOCATION_CREATING_STATUS: 'SET_LOCATION_CREATING_STATUS',
  SET_LOCATION_UPDATING_STATUS: 'SET_LOCATION_UPDATING_STATUS',
  SET_LOCATION_DELETING_STATUS: 'SET_LOCATION_DELETING_STATUS',

  // KB Resources
  SET_KB_RESOURCE_UI_FLAG: 'SET_KB_RESOURCE_UI_FLAG',
  SET_KB_RESOURCE_META: 'SET_KB_RESOURCE_META',
  SET_KB_RESOURCE_FOLDERS: 'SET_KB_RESOURCE_FOLDERS',
  SET_KB_RESOURCE_CURRENT_FOLDER: 'SET_KB_RESOURCE_CURRENT_FOLDER',
  SET_KB_RESOURCES: 'SET_KB_RESOURCES',
  ADD_KB_RESOURCE: 'ADD_KB_RESOURCE',
  EDIT_KB_RESOURCE: 'EDIT_KB_RESOURCE',
  DELETE_KB_RESOURCE: 'DELETE_KB_RESOURCE',
  ADD_KB_RESOURCE_FOLDER: 'ADD_KB_RESOURCE_FOLDER',
  DELETE_KB_RESOURCE_FOLDER: 'DELETE_KB_RESOURCE_FOLDER',
  SET_KB_RESOURCE_TREE: 'SET_KB_RESOURCE_TREE',
};
