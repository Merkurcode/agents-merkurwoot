...
<template>
  <div class="flex flex-col pb-2 overflow-auto">
    <div
      class="min-h-36 relative flex flex-col items-start px-4 py-2 cursor-pointer group hover:bg-opacity-50 border border-n-weak mt-3 shadow outline-1 outline outline-n-container group/cardLayout rounded-2xl bg-n-solid-2"
      draggable="true"
    >
      <div
