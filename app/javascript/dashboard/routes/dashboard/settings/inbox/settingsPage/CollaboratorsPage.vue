...
<template>
  <div>
    ...
    <SettingsFieldSection
      v-if="isWhatsAppGroupsEnabled"
      :label="$t('INBOX_MGMT.ASSIGNMENT_TYPE.LABEL')"
      :help-text="$t('INBOX_MGMT.ASSIGNMENT_TYPE.SUB_TEXT')"
      class="mt-6"
    >
      <select
    ...
    <SettingsFieldSection
      v-if="isWhatsAppGroupsEnabled"
      :label="$t('INBOX_MGMT.WHATSAPP_GROUP_DEFAULT_PHONE.TITLE')"
      :help-text="$t('INBOX_MGMT.WHATSAPP_GROUP_DEFAULT_PHONE.SUB_TITLE')"
      class="mt-6"
    >
