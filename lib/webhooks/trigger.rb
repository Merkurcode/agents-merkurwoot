class Webhooks::Trigger
  ...
  def initialize(url, payload, webhook_type, idempotency_key = nil, secret: nil, delivery_id: nil)
    @url = url
    @payload = payload
  ...
  def self.execute(url, payload, webhook_type, idempotency_key = nil, secret: nil, delivery_id: nil)
    new(url, payload, webhook_type, idempotency_key, secret: secret, delivery_id: delivery_id).execute
  end
